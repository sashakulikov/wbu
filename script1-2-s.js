...
function preload() {
  ...
  img = loadImage("pano_1-1.svg"); // !!! панораму что нужно менять через firebase
}
...
function draw() {
  background(40, 40, 40); // !!! цвет что нужно менять через firebase
  ...
  bgGraphics.sphere(900); // Draw the panorama as a sphere
  bgGraphics.pop();
